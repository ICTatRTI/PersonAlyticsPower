...
#'
#' @field effectSizes List of lists of named numeric vectors. The general form
...
#' variable names. In the example above, \code{length(effectSizes$group1)} is 3,
...
polyICT <- R6::R6Class("polyICT",
     ...
     public  = list(
       ...
       )
       {
         ...
         # effectSizes
         #polyOrder <- checkPolyICT2(effectSizes, corMat, randFxVar) - 1
...
#' @keywords internal
#'
# TODO: update for the new definition of effectSizes
checkPolyICT2 <- function(effectSizes, corMat, randFxVar)
{
